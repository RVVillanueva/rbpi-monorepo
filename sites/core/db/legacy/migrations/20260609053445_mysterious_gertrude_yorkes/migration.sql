...
CREATE TABLE `general_clientsfieldsrequired` (
	`variable` char(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci PRIMARY KEY,
	`label` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`isrequired` tinyint(1) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_clientsmerge` (
	`mergeid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`date` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`clientid1` bigint(10) unsigned NOT NULL,
	`clientname1` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`clientid2` bigint(10) unsigned NOT NULL,
	`clientname2` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_clientsmergetemp` (
	`mergetempid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`date` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`clientid1` bigint(10) unsigned NOT NULL,
	`clientid2` bigint(10) unsigned NOT NULL,
...
CREATE TABLE `general_clientsrelatives` (
	...
	`middlename` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `general_clientsresignation` (
	`resignationTransId` int(10) unsigned PRIMARY KEY,
	`clientid` bigint(10) unsigned NOT NULL,
	`resignationid` mediumint(3) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_clientssolicitor` (
	`pnid` bigint(12) unsigned PRIMARY KEY,
...
CREATE TABLE `general_commagencies` (
	...
	`shortname` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_communications` (
	`id` int(11) AUTO_INCREMENT PRIMARY KEY,
	`filename` varchar(155) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `general_coordinatesetting` (
	`browser` tinyint(1) unsigned PRIMARY KEY,
	`widthadjust` decimal(3,1) NOT NULL,
	`heightadjust` decimal(3,1) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_criticalsettings` (
	`institutionid` smallint(4) unsigned PRIMARY KEY,
	`institutionname` char(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`institutioncode` char(8) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`tin` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`amlaCode` char(18) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cicCode` char(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cocreeCode` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`payrollkey` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`secretKey` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`logo` blob NOT NULL,
	...
	`api_pass_comworks` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`autodayendtime` time NOT NULL,
	`purgeDate` date NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_employeepassword` (
	`passwordhistoryid` int(11) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `general_employees` (
	...
	`firstname` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`middlename` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`lastname` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`suffixname` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`nickname` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`birthdate` date NOT NULL,
	`birthplace` varchar(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`nationality` smallint(3) unsigned NOT NULL,
	`gender` tinyint(3) unsigned NOT NULL,
	`civilstatus` tinyint(3) unsigned NOT NULL,
	`contactnumber1` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`contactnumber2` varchar(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`emergencycontactperson` char(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`emergencycontactnumber` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`clientid` bigint(10) unsigned NOT NULL,
	`savingsid` bigint(10) unsigned NOT NULL,
	`savingsid2` bigint(10) unsigned NOT NULL,
	`sss` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`philhealth` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`pagibig` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`tin` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`payrollAcct` char(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`randomkey` char(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`password` char(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`generatedid` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fingerprint1` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fingerprint2` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fingerprint3` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`image` blob NOT NULL,
...
CREATE TABLE `general_forumcomments` (
	...
	`comment` varchar(700) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`timestamp` timestamp NOT NULL DEFAULT current_timestamp()
);
--> statement-breakpoint
CREATE TABLE `general_forumthreads` (
	`threadid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`thread` varchar(700) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
...
CREATE TABLE `general_holidays` (
	`date` date PRIMARY KEY DEFAULT '0000-00-00',
	`year` char(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`holidayname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`type` tinyint(1) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_holidaysfixed` (
	`date` char(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci PRIMARY KEY,
	`holidayname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_icon` (
	`name` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci PRIMARY KEY,
	`image` blob NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_ipmonitor` (
	`ipid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`ipaddress` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`location` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `general_messages` (
	...
	`subject` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`message` varchar(2000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `general_nationality` (
	...
	`nationality_name` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_relations` (
	`relationid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`relationname` char(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`categoryid` tinyint(1) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_riskprofile` (
	`riskprofilemodel_id` int(11) AUTO_INCREMENT PRIMARY KEY,
	`riskprofilemodel_details` varchar(12000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_settings` (
	`name` char(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci PRIMARY KEY,
	`value` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`description` char(175) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`category` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`type` tinyint(1) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_settingsidentification` (
	...
	`is_cic_identification` tinyint(1) NOT NULL DEFAULT false
);
--> statement-breakpoint
CREATE TABLE `general_settingslog` (
	...
	`timestamp` timestamp NOT NULL DEFAULT current_timestamp(),
	`category` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`name` char(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`value_old` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`value_new` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_systemdate` (
	`systemdateid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`branchid` smallint(4) unsigned NOT NULL,
...
CREATE TABLE `general_update` (
	`updateid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`versiondate` date NOT NULL,
	`postingtime` datetime NOT NULL,
	`updates` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `hr_dagroupsanctions` (
	...
	CONSTRAINT `offenseGroup` UNIQUE INDEX(`offenseGroup`)
);
--> statement-breakpoint
CREATE TABLE `hr_daoffenses` (
	`offenseid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`offensename` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
--> statement-breakpoint
CREATE TABLE `hr_das` (
	`daid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`offenseid` smallint(5) unsigned NOT NULL,
	`language` tinyint(1) unsigned NOT NULL,
	`offenseDetail` varchar(3000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`instance` tinyint(2) unsigned NOT NULL,
	`offenseReply` varchar(3000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`offenseDecision` varchar(3000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_deductionlist` (
	`deductionid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `hr_deductiontype` (
	`deductiontypeid` int(10) unsigned PRIMARY KEY,
	`deductiontypename` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_departments` (
	...
	`departmentname` char(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_eval_appraisal` (
	`appraisalid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`evaluationyear` year(4) NOT NULL,
	`evaluationmonth` tinyint(2) unsigned NOT NULL,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`position` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`department` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`appraisal` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rating_final` decimal(6,3) unsigned NOT NULL,
	`rating_final_computed` decimal(5,2) NOT NULL,
	`comment_appraiser` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`comment_appraisee` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`commitment` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_eval_competency` (
	`competencyid` int(10) unsigned PRIMARY KEY,
	`competencyid_new` varchar(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`competencyname` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_eval_competencytarget` (
	`competencytargetid` int(10) unsigned AUTO_INCREMENT,
	`evaluationyear` year(4) NOT NULL,
	`employeeid` mediumint(6) unsigned NOT NULL,
	...
	`competency` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`competencyweight` decimal(5,2) unsigned NOT NULL,
	...
	CONSTRAINT `targetid` UNIQUE INDEX(`competencytargetid`)
);
--> statement-breakpoint
CREATE TABLE `hr_eval_essential` (
	`essentialid` int(10) unsigned PRIMARY KEY,
	`essentialname` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(1) NOT NULL,
	`parent` int(10) unsigned NOT NULL,
	`childcount` smallint(6) NOT NULL
);
...
CREATE TABLE `hr_eval_groupweight` (
	`positionid` mediumint(4) PRIMARY KEY,
...
CREATE TABLE `hr_eval_oplan` (
	`oplanid` mediumint(6) unsigned PRIMARY KEY,
	`oplanid_new` varchar(6) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_eval_oplanposition` (
	...
	`piid` varchar(6) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`oplanweight` decimal(5,2) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `hr_eval_oplantarget` (
	`oplantargetid` int(10) unsigned AUTO_INCREMENT,
	`evaluationyear` year(4) NOT NULL,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`positionid` mediumint(4) unsigned NOT NULL,
	`kraid` mediumint(6) unsigned NOT NULL,
	`kra` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`pi` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`unitname` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`p11` decimal(12,0) unsigned NOT NULL,
	`p12` decimal(12,0) unsigned NOT NULL,
	CONSTRAINT `oplantargetid` UNIQUE INDEX(`oplantargetid`)
);
--> statement-breakpoint
CREATE TABLE `hr_eval_oplanunit` (
	`unitid` smallint(3) unsigned PRIMARY KEY,
	`unitname` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`vartype` tinyint(1) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `hr_eval_performancematrix` (
	...
	`description` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_eval_settings` (
	`eval_settingsid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	...
	`oplan_template` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`competency_template` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`positions` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`weights` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`performance_matrix` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`conversion` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `hr_eval_target` (
	`targetid` int(10) unsigned AUTO_INCREMENT,
	`evaluationyear` year(4) NOT NULL,
	`employeeid` mediumint(6) unsigned NOT NULL,
	...
	`p11` decimal(12,0) unsigned NOT NULL,
	`p12` decimal(12,0) unsigned NOT NULL,
	CONSTRAINT `targetid` UNIQUE INDEX(`targetid`)
);
--> statement-breakpoint
...
CREATE TABLE `hr_leavesl` (
	`slid` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`employeeid` mediumint(6) unsigned NOT NULL,
	...
	`purpose` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_leavetemp` (
	`leavetempid` int(11) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `hr_leavevl` (
	`vlid` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`datefiled` date NOT NULL,
	`dateapproved` date NOT NULL,
...
--> statement-breakpoint
CREATE TABLE `hr_npa` (
	`npaid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
...
CREATE TABLE `hr_npatemp` (
	`transdate` date NOT NULL,
	`employeeid` mediumint(6) unsigned PRIMARY KEY,
	`effectivitydate` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`employmentstatus` tinyint(4) NOT NULL,
	`payrollstatus` tinyint(1) NOT NULL,
...
CREATE TABLE `hr_ob_seminar` (
	`ob_seminar_id` int(10) AUTO_INCREMENT PRIMARY KEY,
	`ob_seminar_type` int(3) NOT NULL,
	`ob_seminar_unit` tinyint(1) NOT NULL,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`ob_seminar_info` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`startdate` date NOT NULL,
...
CREATE TABLE `hr_overtimepremium` (
	`holidaytype` tinyint(3) unsigned PRIMARY KEY,
...
CREATE TABLE `hr_payrolldata1` (
	`payrollid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
...
CREATE TABLE `hr_payrolldata3` (
	...
	`remarks` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`amortization` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`balance` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `hr_payrolltemp1` (
	`payrolldate` date PRIMARY KEY,
	`payrollfrequency` tinyint(3) unsigned NOT NULL,
	`workdaysofperiod` tinyint(2) NOT NULL,
	`cutoffdate1` date NOT NULL,
	`cutoffdate2` date NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL,
	`ornumber` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`id2` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `hr_payrolltemp2` (
	`payrollid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
...
CREATE TABLE `hr_payrolltemp3` (
	`tempid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`deductiontypeid` smallint(3) unsigned NOT NULL,
	`referenceid` bigint(15) unsigned NOT NULL,
	`remarks` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_positions` (
	`positionid` mediumint(4) unsigned PRIMARY KEY,
	`positionname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`departmentid` smallint(3) unsigned NOT NULL,
...
CREATE TABLE `hr_positiontemp` (
	...
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL,
	`dateCancelled` char(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `hr_ranks` (
	`rankid` int(11) PRIMARY KEY,
	`rankname` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `hr_wtaxbracket` (
	`bracketid` decimal(10,2) PRIMARY KEY,
...
CREATE TABLE `instapay_banks` (
	...
	`mnemonic` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `instapay_fees` (
	`feeid` mediumint(6) unsigned AUTO_INCREMENT PRIMARY KEY,
	`gatewaycode` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `instapay_transactions` (
	...
	`acctname` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`acctno` bigint(10) unsigned NOT NULL,
	`accttype` smallint(2) NOT NULL,
	`acctident` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`tfrname` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`tfrbnkcode` smallint(4) NOT NULL,
	`tfracctno` varchar(19) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`txnamt` decimal(7,2) NOT NULL,
	`tnxdate` char(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`tnxtime` char(6) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`invno` varchar(6) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`param1` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`param2` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`param3` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`custno` varchar(19) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`response_respcode` varchar(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`response_traceno` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`response_respdesc` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
...
CREATE TABLE `insurance_claims` (
	...
	`benefit` char(13) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`diagnosis_id` smallint(5) unsigned NOT NULL,
	`diagnosis_text` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`date_applied` date NOT NULL,
	`claim_date` date NOT NULL,
	`claim_date2` date NOT NULL,
	`claim_availment` tinyint(2) unsigned NOT NULL,
	`claim_amount` decimal(12,2) unsigned NOT NULL,
	`claimant_name` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `insurance_diagnosis` (
	`diagnosis_id` mediumint(8) unsigned PRIMARY KEY,
	`diagnosis_name` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`diagnosis_name2` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`category` mediumint(8) unsigned NOT NULL,
	`parent` mediumint(8) unsigned NOT NULL,
	`level` tinyint(3) unsigned NOT NULL,
	`childcount` smallint(3) unsigned NOT NULL,
	`icd_code` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `insurance_incident` (
	`incidentid` int(6) unsigned AUTO_INCREMENT PRIMARY KEY,
	`incident_type` tinyint(2) NOT NULL,
	`incident` varchar(60) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`death_type` tinyint(2) DEFAULT NULL
);
--> statement-breakpoint
CREATE TABLE `insurance_payments` (
	`paymentid` bigint(12) unsigned PRIMARY KEY,
...
CREATE TABLE `insurance_policy` (
	`policyid` bigint(20) unsigned AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `insurance_policybeneficiary` (
	...
	`relationship` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneficiaryname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`birthdate` date NOT NULL,
	CONSTRAINT `id` UNIQUE INDEX(`id`)
);
--> statement-breakpoint
CREATE TABLE `insurance_policydetail` (
	`policydetail_id` bigint(20) unsigned AUTO_INCREMENT PRIMARY KEY,
	`policyid` bigint(20) unsigned NOT NULL,
	`relationship` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`lastname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`firstname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`middlename` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`birthdate` date NOT NULL,
	`insured_client_status` tinyint(1) DEFAULT false
);
--> statement-breakpoint
CREATE TABLE `insurance_products` (
	`insuranceproductid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`productdetails` varchar(7000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `lending_amortdetailsedit` (
	...
	`justification` varchar(300) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `lending_assetsize` (
	`assetsizeid` mediumint(6) unsigned PRIMARY KEY,
	`name` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `lending_borrowertypes` (
	`borrowertypeid` mediumint(6) unsigned PRIMARY KEY,
	`borrowertypename` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(2) NOT NULL,
...
CREATE TABLE `lending_centers` (
	`centerid` int(10) unsigned PRIMARY KEY,
	`centernumber` smallint(5) unsigned NOT NULL,
	`centername` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`barangayid` mediumint(6) unsigned NOT NULL,
...
CREATE TABLE `lending_centerstemp` (
	`tempid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`centernumber` smallint(5) unsigned NOT NULL,
	`centername` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`barangayid` mediumint(6) unsigned NOT NULL,
	`meetingday` tinyint(4) NOT NULL,
...
CREATE TABLE `lending_centerstransfer` (
	`transid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`transDate` date NOT NULL,
...
CREATE TABLE `lending_clientgroup` (
	`clientgroupid` mediumint(6) unsigned PRIMARY KEY,
	`name` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(2) NOT NULL,
	`parent` mediumint(6) NOT NULL,
	`childcount` smallint(3) NOT NULL
...
CREATE TABLE `lending_creditline_data` (
	`creditline_id` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`branchid` smallint(4) unsigned NOT NULL,
	`clientid` bigint(10) unsigned NOT NULL,
	...
	`creditline_approvers` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`creditline_status` tinyint(4) NOT NULL,
	`creditline_notes` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `lending_creditline_product` (
	`creditline_productid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`creditline_productname` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`productdescription` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_creditscore_data` (
	`creditscore_id` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	...
	`risklevel_name` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`details` varchar(10000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `lending_creditscore_template` (
	`creditscore_template_id` smallint(5) AUTO_INCREMENT PRIMARY KEY,
	`creditscore_name` varchar(60) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`creditscore_description` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`creditscore_template` varchar(15000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_discount` (
	`discountid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`pnid` bigint(12) unsigned NOT NULL,
	...
	`justification` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `lending_economicactivities` (
	`id` mediumint(6) AUTO_INCREMENT PRIMARY KEY,
	`name` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(2) NOT NULL,
	`parent` mediumint(6) NOT NULL,
	`childcount` smallint(3) NOT NULL
...
CREATE TABLE `lending_industries` (
	`industryid` tinyint(3) unsigned PRIMARY KEY,
	`industryname` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`defaultname` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_insformcoordinates` (
	...
	`data` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`x` decimal(5,1) unsigned NOT NULL,
	`y` decimal(5,1) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `lending_insuranceproviders` (
	`insuranceproviderid` tinyint(3) unsigned AUTO_INCREMENT PRIMARY KEY,
	`name` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`shortname` varchar(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_letters` (
	`letterid` smallint(6) PRIMARY KEY,
	...
	`code_letter` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	CONSTRAINT `letterid` UNIQUE INDEX(`letterid`)
);
--> statement-breakpoint
CREATE TABLE `lending_loanclassifications` (
	`loanclassid` smallint(3) unsigned PRIMARY KEY,
	`name` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`defaultname` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_loandetails` (
	`pnid` bigint(12) unsigned PRIMARY KEY,
	`pnid_previous_cbs` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`clientid` bigint(10) unsigned NOT NULL,
	`spouseid` bigint(10) unsigned NOT NULL,
	`pnid2` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`loanproductid` int(11) unsigned NOT NULL,
	...
	`proceedsreference` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`loanclassid` smallint(3) unsigned NOT NULL,
	`loanpurposeid` mediumint(6) unsigned NOT NULL,
	`loanpurpose` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`securityid` mediumint(6) unsigned NOT NULL,
	`securitydetails` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`application_details` mediumtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_loandetails_changes` (
	...
	`pnid` bigint(12) unsigned NOT NULL,
	`transdate` date NOT NULL,
	`changes` varchar(10000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`dateposted` date NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
...
CREATE TABLE `lending_loanproducts` (
	`loanproductid` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`status` tinyint(1) unsigned NOT NULL,
	`name` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`shortname` char(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`collectionlist_options` varchar(3000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`amort_workdays` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`autodebitAmort` tinyint(1) unsigned NOT NULL,
	...
	`scdiscountedname` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`scamortname` char(18) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`penaltyrates` varchar(3000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`insurancename` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`savingsdiscountedname` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`savingsamortizedname` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction1name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction2name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction3name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction4name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction5name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction6name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction7name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction8name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`deduction9name` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`amort1name` char(18) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`amort2name` char(18) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`code_pn` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`code_pn2` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`code_appform` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`approval_data` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`comakerLimit` tinyint(2) unsigned NOT NULL,
	`creditscore_template_id` smallint(1) unsigned NOT NULL,
	`is_offbook` tinyint(1) NOT NULL DEFAULT false
);
--> statement-breakpoint
...
CREATE TABLE `lending_loanpurpose` (
	`loanpurposeid` mediumint(6) unsigned AUTO_INCREMENT PRIMARY KEY,
	`name` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(2) NOT NULL,
	`parent` mediumint(6) NOT NULL,
	`childcount` smallint(3) NOT NULL
...
CREATE TABLE `lending_loansecurities` (
	`loansecurityid` mediumint(6) unsigned AUTO_INCREMENT PRIMARY KEY,
	`name` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_loanstatus` (
	`loanstatusid` tinyint(3) unsigned PRIMARY KEY,
	`loanstatusname` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `lending_misposting` (
	...
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL,
	`justification` varchar(300) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`status` tinyint(4) NOT NULL,
	`is_cancelled` tinyint(1) unsigned NOT NULL,
	`txn_log` varchar(5000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `lending_mispostingtemp` (
	...
	`transdate` date NOT NULL,
	`orid` bigint(12) unsigned PRIMARY KEY,
	`justification` varchar(300) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
...
CREATE TABLE `lending_mobile_loanapplication` (
	`tempid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`clientid` bigint(10) unsigned NOT NULL,
	`cpnumber` varchar(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`amount` decimal(12,2) NOT NULL,
	`termunit` tinyint(1) unsigned NOT NULL,
	`term` smallint(4) unsigned NOT NULL,
	`loanpurpose` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`postingtime` datetime NOT NULL,
	`status` tinyint(1) NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `lending_moratoriumtemp` (
	`moratoriumid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`postingtime` datetime NOT NULL,
...
CREATE TABLE `lending_office` (
	`officeid` int(6) unsigned AUTO_INCREMENT PRIMARY KEY,
	`officename` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
...
CREATE TABLE `lending_payment_tempor` (
	`orid` bigint(12) unsigned PRIMARY KEY,
	`orstatus` tinyint(1) NOT NULL DEFAULT false,
...
CREATE TABLE `lending_payments` (
	`paymentid` bigint(12) unsigned AUTO_INCREMENT PRIMARY KEY,
	`postingtime` datetime NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	...
	`paymentreference` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `lending_paymentsor` (
	`orid` bigint(12) unsigned AUTO_INCREMENT PRIMARY KEY,
	`postingtime` datetime NOT NULL,
	`transdate` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	...
	`paymentreference` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`glcode` int(9) unsigned NOT NULL,
...
CREATE TABLE `lending_pncorrection` (
	`correctionid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`pnid` bigint(12) unsigned NOT NULL,
	`clientid` bigint(10) unsigned NOT NULL,
	`correction_type` tinyint(1) unsigned NOT NULL,
	`date_transacted` date NOT NULL,
	`details_before` varchar(30000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`details_after` varchar(30000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `lending_releasedelete` (
	`releasedeleteid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	...
	`reason` varchar(300) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `lending_remittancedelete` (
	...
	`clientname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`amount` decimal(12,2) unsigned NOT NULL,
	`userid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL,
...
CREATE TABLE `lending_termunits` (
	...
	`termname` varchar(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `mis_bug` (
	...
	`approver1id` mediumint(6) unsigned NOT NULL,
	`details` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`measures` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`status` tinyint(4) NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `mis_userrightguide` (
	`userrightid` int(6) PRIMARY KEY,
	`title` char(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`parent` int(6) NOT NULL,
	`level` tinyint(1) NOT NULL,
	`level1access` tinyint(1) unsigned NOT NULL,
	`level2access` tinyint(1) unsigned NOT NULL,
	`level3access` tinyint(1) unsigned NOT NULL,
	`level1note` char(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level2note` char(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level3note` char(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `mobile_account_verification` (
	...
	`clientid` bigint(10) unsigned NOT NULL,
	`cpnumber` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cpnumber_new` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`selfie1` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`selfie2` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`selfie3` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`userpin_key` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`userpin_salt` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`statusid` tinyint(1) DEFAULT false,
	...
	`is_temp` tinyint(1) DEFAULT false
);
--> statement-breakpoint
CREATE TABLE `mobile_client_users` (
	`idmobile_client_users` int(11) AUTO_INCREMENT PRIMARY KEY,
	...
	`activitylog` datetime NOT NULL,
	`cpimei` text CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
	`userpin` varchar(512) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`questionid` smallint(3) NOT NULL,
	`answer` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `mobile_comworks_eload` (
	`id` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`requestRefNo` varchar(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`targetSubsAccount` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`planCode` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`retailerNewBalance` varchar(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`respCode` varchar(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`status` varchar(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`statusDesc` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`client_transactionid` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `mobile_security_questions` (
	`questionid` smallint(3) AUTO_INCREMENT PRIMARY KEY,
	`name` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `pesonet_banks` (
	`bankid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`bicfi` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`bank_name` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`bank_code` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`head_office_brstn` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `pesonet_inwardtransactions` (
	`id` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`MsgId` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`CreDtTm` varchar(13) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`NbOfTxs` smallint(3) NOT NULL,
	`TtlIntrBkSttlmAmt_Ccy` char(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`TtlIntrBkSttlmAmt_value` decimal(12,2) NOT NULL,
	`IntrBkSttlmDt` date NOT NULL,
	`SttlmInf_SttlmMtd` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`InstgAgt_BICFI` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`InstdAgt_BICFI` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`PmtId_EndToEndId` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`PmtId_TxId` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`PmtTpInf_Prtry` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`PmtTpInf_Cd` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`IntrBkSttlmAmt_Ccy` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`IntrBkSttlmAmt_value` decimal(12,2) NOT NULL,
	`ChrgBr` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Dbtr_Nm` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Dbtr_address1` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Dbtr_address2` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Dbtr_address3` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`DbtrAcct_Id` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`DbtrAcct_BICFI` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Cdtr_Nm` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Cdtr_PstlAdr1` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Cdtr_PstlAdr2` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`Cdtr_PstlAdr3` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`CdtrAcct_Id` bigint(10) unsigned NOT NULL,
	`CdtrAgt_BICFI` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`instructions` varchar(33) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rfi_reference_number` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`ofi_customer_reference_number` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rfi_customer_reference_number` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`statuscode` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`transdate` date NOT NULL,
...
CREATE TABLE `pesonet_outwardtemp` (
	`tempid` bigint(20) unsigned AUTO_INCREMENT PRIMARY KEY,
	`ofirefnum` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rfirefnum` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`oficustomerrefnum` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`rficustomerrefnum` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`currency` char(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`amount` decimal(12,2) NOT NULL,
	`fee` decimal(6,2) NOT NULL,
	`activitycode` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`transcode` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`senderbic` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`savingsid` bigint(10) NOT NULL,
	`sendername` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`senderaddress` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiverbic` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiversa` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receivername` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiveraddress` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`reference` varchar(33) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`transdate` date NOT NULL,
...
CREATE TABLE `pesonet_outwardtransactions` (
	`transid` bigint(20) unsigned AUTO_INCREMENT PRIMARY KEY,
	`sequence` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`ofirefnum` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rfirefnum` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`oficustomerrefnum` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rficustomerrefnum` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`currency` char(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`amount` decimal(12,2) NOT NULL,
	`fee` decimal(6,2) NOT NULL,
	`activitycode` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`senderaddress` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiverbic` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiversa` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receivername` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiveraddress` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`reference` varchar(33) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`transdate` date NOT NULL,
	...
	`channel` tinyint(1) NOT NULL,
	`update_statuscode` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`update_information` varchar(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `regulation_reports` (
	`report` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci PRIMARY KEY,
	`gl_accounts` varchar(10000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cutoffdate` date NOT NULL,
	`gl_data` varchar(10000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`sl_data` varchar(10000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `rm_category` (
	`categoryid` int(5) PRIMARY KEY,
	`categoryname` char(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`parent` int(5) NOT NULL,
	`level` tinyint(1) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `rm_concerns` (
	`concernid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	...
	`reporter_name` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`reporter_cpnumber` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`concerned_name` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`concerned_cpnumber` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`particulars` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`categoryid` char(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`action` tinyint(1) NOT NULL,
	`action_maker` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`action_escalator` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
...
CREATE TABLE `rm_concernsettings` (
	`name` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci PRIMARY KEY,
	`data` varchar(50000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `rm_diary` (
	`diaryid` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`postingTime` datetime NOT NULL,
	`clientid` bigint(20) unsigned NOT NULL,
	`concern` tinyint(1) unsigned NOT NULL,
	`concernid` bigint(12) unsigned NOT NULL,
	`entry` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `rm_event` (
	...
	`eventdetails` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rootcause` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`actiontaken` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `ropa_details` (
	`ropaid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`branchid` char(8) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`ropaNumber` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`date` date NOT NULL,
	...
	`ropaimage` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `ropa_salespaymentdetails` (
	...
	`ornumber` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`buyer` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`otherexpenses` decimal(12,2) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `savings_accounts` (
	`savingsid` bigint(10) unsigned PRIMARY KEY,
	`savingsid_previous_cbs` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`accountname` char(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	...
	`note1` char(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`note2` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`holdout` decimal(12,2) unsigned NOT NULL,
	`adb` decimal(12,2) unsigned NOT NULL,
	`is_wtax_exempt` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`is_frozen` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`hash` char(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`postingtime` datetime NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`solicitorid` mediumint(6) unsigned NOT NULL,
	`openAmount` decimal(12,2) unsigned NOT NULL,
	`from_mobile` tinyint(1) NOT NULL DEFAULT false
);
--> statement-breakpoint
...
CREATE TABLE `savings_certificate_letter` (
	`savingscertificateid` smallint(6) PRIMARY KEY,
	`code1` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `savings_changes` (
	`change_id` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`savingsid` bigint(10) unsigned NOT NULL,
	`transdate` date NOT NULL,
	`change_type` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`change_details` varchar(25000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` varchar(6) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`approverid` varchar(6) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `savings_checkdeptemp` (
	`savingsid` bigint(10) unsigned NOT NULL,
	`checktype` tinyint(3) unsigned NOT NULL,
	`checkdetails` varchar(34) CHARACTER SET utf16 COLLATE utf16_general_ci NOT NULL,
	`checkamount` decimal(12,2) unsigned NOT NULL,
	`clearingdays` tinyint(3) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `savings_checksforceclear` (
	`savingstransactionid` bigint(12) unsigned PRIMARY KEY,
	`systemdate` date NOT NULL,
...
CREATE TABLE `savings_checksonfloat` (
	`savingstransactionid` bigint(12) PRIMARY KEY,
	`branchid` smallint(4) unsigned NOT NULL,
	`savingsid` bigint(10) unsigned NOT NULL,
	...
	`amount` decimal(12,2) unsigned NOT NULL,
	`checktype` tinyint(3) unsigned NOT NULL,
	`reference` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`check_number` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`clearingdays` tinyint(3) unsigned NOT NULL,
...
CREATE TABLE `savings_clearingdays` (
	...
	`name` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `savings_products` (
	`productid` mediumint(5) unsigned AUTO_INCREMENT PRIMARY KEY,
	`productname` char(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`productcode` char(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`charmask` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`dormantLetter` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`tyLetter` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `savings_ssaplacementdetails` (
	`placementid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`savingstransactionid` bigint(12) unsigned NOT NULL,
...
CREATE TABLE `savings_ssa_recompute` (
	...
	`transactor` varchar(300) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`details` varchar(25000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `savings_transactioncodes` (
	`transaction` smallint(6) PRIMARY KEY,
	...
	`code` char(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`shortcut` char(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `savings_transactions` (
	`savingstransactionid` bigint(12) unsigned AUTO_INCREMENT PRIMARY KEY,
	`branchid` smallint(4) unsigned NOT NULL,
	...
	`reference` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`currentbalance1` decimal(12,2) NOT NULL,
	`currentbalance2` decimal(12,2) NOT NULL,
...
CREATE TABLE `savings_uploads` (
	...
	`reference` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`glcode` int(9) unsigned NOT NULL,
	`transaction` smallint(3) unsigned NOT NULL,
	`transcount` smallint(3) unsigned NOT NULL,
	`postamount` decimal(12,2) unsigned NOT NULL,
	`array_data` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `scr_discount` (
	`discountid` int(10) unsigned PRIMARY KEY,
	`transdate` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`pnid` bigint(12) unsigned NOT NULL,
	`discountinterest` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `scr_loandetails` (
	`scrid` bigint(12) unsigned PRIMARY KEY,
	`clientid` bigint(10) unsigned NOT NULL,
	`ropaid` bigint(12) NOT NULL,
	`spouseid` int(11) NOT NULL,
	`scrid2` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(3) unsigned NOT NULL,
...
CREATE TABLE `scr_loandetailstemp` (
	`scrid` bigint(12) unsigned AUTO_INCREMENT PRIMARY KEY,
	...
	`interest` decimal(10,2) unsigned NOT NULL,
	`servicecharge` decimal(10,2) unsigned NOT NULL,
	`servicechargediscountedflex` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`scamortvalue` decimal(10,2) unsigned NOT NULL,
	...
	`principalIntervalIrregular` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`amortdetailstemp` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `scr_settings` (
	`settingid` int(12) AUTO_INCREMENT PRIMARY KEY,
	`status` tinyint(1) unsigned NOT NULL,
	...
	`amortoption` text CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
	`autodebitAmort` tinyint(1) unsigned NOT NULL,
	`aclAssessment` decimal(12,0) unsigned NOT NULL,
	`scdiscounteduse` tinyint(1) unsigned NOT NULL,
	`scdiscountedname` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `sl_balances` (
	`slbalanceid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`date` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
...
CREATE TABLE `sl_bank` (
	...
	`branchname` varchar(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`accounttype` tinyint(4) NOT NULL,
	`accountnumber` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`contactperson` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`contactnumber` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`accreditation_number` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `sl_bankparent` (
	`parentbankid` mediumint(4) unsigned AUTO_INCREMENT PRIMARY KEY,
	`bankname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`bankcode` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`banktype` tinyint(4) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `sl_banktransactions` (
	...
	`branchid` smallint(4) unsigned NOT NULL,
	`details` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `sl_consumabledispatch` (
	`dispatchid` int(11) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `sl_consumableitems` (
	`consumableid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`consumablename` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(2) NOT NULL,
	`parent` int(10) NOT NULL,
	`childcount` smallint(3) NOT NULL,
...
CREATE TABLE `sl_consumableordersdetails` (
	`orderdetailid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`orderid` int(10) unsigned NOT NULL,
	`consumableId` int(10) unsigned NOT NULL,
...
CREATE TABLE `sl_consumabletrans` (
	`consumabletransid` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`branchid` smallint(4) unsigned NOT NULL,
	`consumableid` int(10) unsigned NOT NULL,
	`transdate` date NOT NULL,
	`transaction` tinyint(2) unsigned NOT NULL,
...
CREATE TABLE `sl_creditor` (
	`creditorid` int(6) unsigned AUTO_INCREMENT PRIMARY KEY,
	`creditorname` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`shortname` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`creditline` decimal(12,2) NOT NULL,
	`description` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fundertag` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`balance` decimal(14,2) NOT NULL,
	`bankid` int(10) unsigned NOT NULL,
	`glcode` int(9) unsigned NOT NULL,
	`interestglcode` int(9) unsigned NOT NULL,
...
CREATE TABLE `sl_creditorsmswarningrecipient` (
	`employeeid` mediumint(4) PRIMARY KEY
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `sl_ffe` (
	`ffeid` mediumint(6) unsigned PRIMARY KEY,
	`ffetypeid` smallint(3) NOT NULL,
	`model` char(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`serialid` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`description` char(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`supplier` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
...
CREATE TABLE `sl_ffemovement` (
	`ffemovementid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	`ffeid` mediumint(6) unsigned NOT NULL,
...
CREATE TABLE `sl_ffetype` (
	...
	`ffetypename` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `sl_ffetypecategory` (
	`category` tinyint(1) unsigned PRIMARY KEY,
	`categoryname` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`glcode` int(9) unsigned NOT NULL,
...
--> statement-breakpoint
CREATE TABLE `sl_htm` (
	`htm_id` int(11) AUTO_INCREMENT PRIMARY KEY,
	`issuer_id` tinyint(1) unsigned DEFAULT NULL,
	`security_type` tinyint(1) unsigned NOT NULL,
	`compliance` tinyint(1) unsigned NOT NULL,
	`accreditation_number` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`isin` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `sl_receivable` (
	`receivableid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	`employeeid` mediumint(6) unsigned NOT NULL,
	`detail` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`payment` decimal(10,2) NOT NULL,
...
CREATE TABLE `sl_stock_certificate` (
	...
	`certificateNo` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`certificateShares` decimal(10,2) NOT NULL,
	`certificateAmount` decimal(12,2) NOT NULL,
	`certificateReference` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `sl_stock_dividend` (
	`dividendid` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `sl_stock_shareholders` (
	`shareholderid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`clientid` bigint(10) unsigned NOT NULL,
...
CREATE TABLE `sl_stock_subscription` (
	...
	`reference` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`subscribeShares` decimal(10,2) unsigned NOT NULL,
	`subscribeAmount` decimal(12,2) unsigned NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL
);
...
CREATE TABLE `sms_inbox` (
	`messageID` bigint(12) unsigned AUTO_INCREMENT PRIMARY KEY,
	`smsNumber` char(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`smsMessage` varchar(480) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `sms_outbox` (
	`messageID` bigint(12) AUTO_INCREMENT PRIMARY KEY,
	`smsNumber` char(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`smsMessage` varchar(480) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `sms_sentcount` (
	`sentDate` date PRIMARY KEY,
	`sentCount` decimal unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `sms_telco_prefix` (
	`prefix` smallint(4) unsigned zerofill PRIMARY KEY,
	`gateway_id` int(2) DEFAULT NULL,
	`network` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `tellering_errorcorrecttemp` (
	`transactionid` int(11) unsigned PRIMARY KEY,
	`branchid` smallint(4) unsigned NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
CREATE TABLE `tellering_expense` (
	`expenseid` int(10) unsigned AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`description` char(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`type` tinyint(1) unsigned NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `tellering_orcoordinate` (
	...
	`json_data` varchar(26000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `tellering_printcoordinates` (
	`variable` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`coordinate` decimal(4,1) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `tellering_settings` (
	`telleringid` smallint(3) unsigned PRIMARY KEY,
	`telleringname` char(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`glcode` int(9) unsigned NOT NULL,
...
CREATE TABLE `tellering_transactions` (
	`transactionid` int(11) unsigned AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	`postingtime` datetime NOT NULL,
	`branchid` smallint(4) unsigned NOT NULL,
	`telleringid` mediumint(3) unsigned NOT NULL,
	`details` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`glcode` int(9) unsigned NOT NULL,
	`document1` tinyint(1) NOT NULL,
	`document2` tinyint(1) NOT NULL,
	`reference1` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`reference2` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`amount` decimal(12,2) NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL,
	`approverid` mediumint(6) unsigned NOT NULL,
...
CREATE TABLE `vw_mobile_prefix` (
	`prefix` varchar(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`telco` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL'
);
--> statement-breakpoint
CREATE TABLE `writeoff_approval` (
	`writeoffid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`postingtime` datetime NOT NULL,
...
CREATE TABLE `acctng_branchcostcenters` (
	...
	`costcenterid` smallint(6) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_clients_riskprofiles` (
	`riskprofile_id` int(11) AUTO_INCREMENT PRIMARY KEY,
	`riskprofile_timestamp` datetime NOT NULL DEFAULT current_timestamp(),
	`clientid` bigint(10) unsigned NOT NULL,
	`riskprofilemodel_id` int(11) NOT NULL,
	`riskprofile_details` varchar(5000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`riskprofile_narration` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`riskprofile_category` varchar(7) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(6) unsigned NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `mobile_transfer_details` (
	...
	`receiver_accountnumber` varchar(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiver_accountname` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiver_nickname` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`receiver_address` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`bicfi` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `acctng_budget` (
	...
	`gltype` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`costcenterid` smallint(6) NOT NULL,
	`branchid` smallint(6) NOT NULL,
...
CREATE TABLE `acctng_date` (
	`changeid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`current_acctngdate` date DEFAULT 'NULL',
	`proposed_acctngdate` date DEFAULT 'NULL',
	`branchid` mediumint(9) DEFAULT 0,
	`makerid` mediumint(9) DEFAULT 0,
	`approverid` mediumint(9) DEFAULT 0
);
--> statement-breakpoint
CREATE TABLE `acctng_financialratios` (
	`finratio` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci PRIMARY KEY,
	`finratio_name` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`formula` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`category` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`numerator` varchar(2000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`denominator` varchar(2000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`is_annualized` tinyint(4) NOT NULL,
	`benchmark` decimal(4,2) unsigned NOT NULL,
	`benchmark_date` date NOT NULL,
	`view_sequence` tinyint(4) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `acctng_glaccounts` (
	`gl_code` int(11) NOT NULL,
	`frpcode` char(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`gl_name` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`gl_type` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`gl_level` tinyint(4) NOT NULL,
	`gl_parent` int(11) NOT NULL,
	`gl_childcount` smallint(6) NOT NULL,
	`userlevel` tinyint(4) NOT NULL,
	CONSTRAINT `gl_account_code` UNIQUE INDEX(`gl_code`)
);
--> statement-breakpoint
CREATE TABLE `acctng_journaldetails` (
	`journal_details_id` int(11) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `acctng_journals` (
	`journalid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`ibjournalid` int(11) NOT NULL,
	`journal_description` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`journal_date` date NOT NULL,
	`timestamp` timestamp NOT NULL DEFAULT current_timestamp(),
	`journal_branch` smallint(6) NOT NULL,
	`user` mediumint(9) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `acctng_journal_ibtracker` (
	`ib_journal_details_id` int(11) NOT NULL,
	`journal_details_id` int(11) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `acctng_journal_trail` (
	`trail_id` int(11) AUTO_INCREMENT PRIMARY KEY,
	`timestamp` datetime NOT NULL DEFAULT current_timestamp(),
	`acctng_date` date DEFAULT 'NULL',
	`process` varchar(7) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(6) DEFAULT 0,
	`journalid` int(11) DEFAULT 0,
	`ibjournalid` int(11) NOT NULL,
	`trail_before` varchar(10000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`trail_after` varchar(10000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(9) DEFAULT 0,
	`approverid` mediumint(9) DEFAULT 0
);
--> statement-breakpoint
CREATE TABLE `amlc_transaction` (
	`amlcId` int(11) AUTO_INCREMENT PRIMARY KEY,
	`transType` tinyint(4) NOT NULL,
	`dataType` tinyint(4) NOT NULL,
	`referenceType` tinyint(4) NOT NULL,
	`referenceId` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`description` varchar(75) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`transCode` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(6) NOT NULL,
	`amlcBranchid` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`transDate` date NOT NULL,
	`postingtime` datetime NOT NULL,
	`transAmount` decimal(12,2) unsigned NOT NULL,
	`clientid1` bigint(20) NOT NULL,
	`clientid2` bigint(20) NOT NULL,
	`clientid3` bigint(20) NOT NULL,
	`clientid4` bigint(20) NOT NULL,
	`beneFlag` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneLastname` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneFirstname` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneMiddlename` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneAddress` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneBarangayid` mediumint(9) NOT NULL,
	`beneAccountNumber` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneBirthdate` date NOT NULL,
	`beneBirthPlace` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneNationality` smallint(6) NOT NULL,
	`beneIdType` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneIdNumber` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneTelephone` varchar(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`beneBusinessNature` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` smallint(6) NOT NULL,
	`status` tinyint(4) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `amlc_transcode` (
	`amlcCodeId` mediumint(9) AUTO_INCREMENT PRIMARY KEY,
	`code` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`description` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`submissionType` tinyint(4) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `atm_api_logs` (
	`logid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`token` varchar(512) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`code` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`trace_number` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`message` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`account_number` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	...
	`origin` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`amount` float DEFAULT 0,
	`to_account_number` int(11) DEFAULT 0,
	`type` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`date_created` timestamp NOT NULL DEFAULT current_timestamp(),
	`source_ip` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL'
);
--> statement-breakpoint
...
CREATE TABLE `audit_details` (
	...
	`detailsIndex` smallint(6) NOT NULL,
	`policyrefid` int(11) NOT NULL,
	`finding` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`findingRisk` tinyint(4) NOT NULL,
	`demerit` tinyint(4) NOT NULL,
	`isRecurring` tinyint(4) NOT NULL,
	`noResponse` tinyint(4) NOT NULL,
	`response` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`dateTarget` date NOT NULL,
	`compliance` tinyint(4) NOT NULL,
	`dateComplied` date NOT NULL,
	`comment` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`detailStatus` tinyint(4) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `audit_policyref` (
	`policyrefid` int(11) PRIMARY KEY,
	`policyrefname` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(4) NOT NULL,
...
CREATE TABLE `audit_profile` (
	`auditid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`audittype` tinyint(4) NOT NULL,
	`officetype` tinyint(4) NOT NULL,
	`officeid` mediumint(9) NOT NULL,
	...
	`dateReply` date NOT NULL,
	`auditorid` mediumint(9) NOT NULL,
	`managerid` mediumint(9) NOT NULL,
	`manageraccess` tinyint(4) NOT NULL,
	`auditrating` decimal(4,2) unsigned NOT NULL,
	`riskClassification` tinyint(4) NOT NULL,
...
CREATE TABLE `checking_autodebitaccount` (
	`savingsid` bigint(20) PRIMARY KEY,
	`autodebitsavingsid` bigint(20) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `checking_bookletdetails` (
	`checkbookletid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`dateRequest` date NOT NULL,
	`dateIssued` date NOT NULL,
	`branchid` smallint(6) NOT NULL,
	`savingsid` bigint(20) NOT NULL,
	`conduitbankid` smallint(6) NOT NULL,
	`checktype` tinyint(4) NOT NULL,
	`charging` tinyint(4) NOT NULL,
	`checknumberstart` bigint(20) NOT NULL,
	`checknumberend` bigint(20) NOT NULL,
	`makerid` mediumint(9) NOT NULL,
	`savingstransactionid` bigint(20) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `checking_checks_issued` (
	`check_issued_id` bigint(20) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `checking_conduitbank` (
	`conduitbankid` smallint(6) AUTO_INCREMENT PRIMARY KEY,
	`bankid` mediumint(9) NOT NULL,
	`textfile_settings` varchar(25000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`errorchecked` tinyint(4) NOT NULL,
	`status` tinyint(4) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `checking_inward1` (
	`inwardid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	`conduitbankid` mediumint(9) NOT NULL,
	`item_count` mediumint(9) NOT NULL,
	`total_amount` decimal(12,2) unsigned NOT NULL,
	`textfile_md5` char(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(9) NOT NULL,
	`approverid` mediumint(9) NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `checking_inwardtemp1` (
	...
	`item_count` mediumint(9) NOT NULL,
	`total_amount` decimal(12,2) unsigned NOT NULL,
	`inwardChecked` tinyint(4) NOT NULL,
	`textfile_md5` char(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(9) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `checking_inwardtemp2` (
	`inward_details_id` int(11) AUTO_INCREMENT PRIMARY KEY,
	`tempid` int(11) NOT NULL,
	`checknumber` char(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`brstn` char(9) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`amount` decimal(14,2) unsigned NOT NULL,
	`amountToDebit` decimal(12,2) unsigned NOT NULL,
	`savingsid` bigint(20) NOT NULL,
	`autoDetect` tinyint(4) NOT NULL,
	`checkstatus` smallint(6) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `checking_loanpayments` (
	`orid` bigint(20) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `checking_outward` (
	`outward_id` int(11) AUTO_INCREMENT PRIMARY KEY,
	`transdate` date NOT NULL,
	`conduitbankid` tinyint(4) NOT NULL,
	`item_count` mediumint(9) NOT NULL,
	`total_amount` decimal(12,2) unsigned NOT NULL,
	`upload_data` varchar(50000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`textfile_md5` char(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`makerid` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`approverid` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `checking_request` (
	...
	`conduitbankid` smallint(6) NOT NULL,
	`checktype` tinyint(4) NOT NULL,
	`checkcount` smallint(6) NOT NULL,
	`checkissued` smallint(6) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `checking_spo` (
	`spoid` int(11) AUTO_INCREMENT PRIMARY KEY,
	...
	`makerid` mediumint(9) NOT NULL,
	`spostatus` tinyint(4) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `collateral` (
	`collateralid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`collateraltype` int(11) NOT NULL,
	`lotClass1` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`lotClass2` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`clientid` bigint(20) NOT NULL,
	`registeredOwner` char(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`collateralNumber` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`lotNo` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`landArea` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`collateralLocation` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`latitude` decimal(10,7) NOT NULL,
	`longitude` decimal(10,7) NOT NULL,
	`barangay` mediumint(9) NOT NULL,
	`action` smallint(6) NOT NULL,
	`collateralImage` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`spaImage` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`date` date NOT NULL,
	`map` int(11) NOT NULL,
	`branchid` smallint(6) NOT NULL,
	`plateNo` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`chassisNo` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`serialNo` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`brand` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`modelNo` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `collateral_appraisal` (
	`appraisalid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`collateralid` int(11) NOT NULL,
	...
	`improvementsReport` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`pieces` int(11) NOT NULL,
	`appraisalReport` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `collateral_appraisal_images` (
	...
	`imageName` char(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`imageCaption` char(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `collateral_movements` (
	`receiverid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`employeeid` mediumint(9) NOT NULL,
	`collateralNumber` int(11) NOT NULL,
	`date` date NOT NULL,
	`transactionDetails` char(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`action` int(11) NOT NULL,
	`status` int(11) NOT NULL,
	`isReceived` smallint(6) NOT NULL,
	`receiver` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`branchid` smallint(6) NOT NULL,
	`previousbranchid` smallint(6) NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `core_api_users` (
	`apiuserid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`username` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`user_salt` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`user_key` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `ffe_macaddress` (
	`ffeid` mediumint(9) NOT NULL,
	`macaddress` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `frp_loans` (
	`cutoffdate` date NOT NULL,
	`loanproductid` int(11) NOT NULL,
	`loanclassid` smallint(6) NOT NULL,
	`industryid` tinyint(4) NOT NULL,
	`securityid` mediumint(9) NOT NULL,
	`loanpurposeid` mediumint(9) NOT NULL,
	`termCat1` tinyint(4) NOT NULL,
	`termCat2` tinyint(4) NOT NULL,
	`nplBracket` varchar(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`loanstatus` tinyint(4) NOT NULL,
	`loanstatusprevious` tinyint(4) NOT NULL,
...
CREATE TABLE `frp_reports` (
	`id` smallint(6) AUTO_INCREMENT PRIMARY KEY,
	`report_name` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`report_data` mediumtext CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `frp_savings` (
	`cutoffdate` date NOT NULL,
	`savingsid` bigint(20) NOT NULL,
	`savingscategory` tinyint(4) NOT NULL,
	`currentbalance1` decimal(12,2) NOT NULL,
	`currentbalance2` decimal(12,2) NOT NULL,
	`accountstatus` tinyint(4) NOT NULL,
	`termDays` smallint(6) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_activities` (
	...
	`main_module` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`sub_module` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`activity_process` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`activity_details` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`subject_category` tinyint(4) NOT NULL,
...
CREATE TABLE `general_address` (
	...
	`town` varchar(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`province` varchar(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`region` varchar(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`addresscomplete` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(4) NOT NULL,
	`parent` mediumint(9) NOT NULL,
	`level_psgc` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`code_parent` int(11) NOT NULL,
	`zipcode` varchar(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`isHighRisk` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `general_branchcoverage` (
	...
	`town` mediumint(9) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_branches` (
	`id` smallint(6) PRIMARY KEY,
	`branchid2` char(8) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`bspcode` char(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`name` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`shortname` char(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`bir_branchcode` char(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`addressdetail` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`addressbarangay` mediumint(9) NOT NULL,
	`latitude` decimal(10,7) unsigned NOT NULL,
	`longitude` decimal(10,7) unsigned NOT NULL,
	`contactnumber` varchar(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`level` tinyint(4) NOT NULL,
	`parent` smallint(6) NOT NULL,
	`interbranch_parent` smallint(6) NOT NULL,
	`childcount` tinyint(4) NOT NULL,
	`branchhead` mediumint(9) NOT NULL,
	`checker` mediumint(9) NOT NULL,
	`cohlimit` decimal(10,2) NOT NULL,
	`systemdate` date NOT NULL,
	`branchstatus` tinyint(4) NOT NULL,
	`clearing_adjustment` tinyint(4) NOT NULL,
	`allowpostingonsaturdays` tinyint(4) NOT NULL,
	`allowpostingonsundays` tinyint(4) NOT NULL,
	`excludeddayposting` tinyint(4) DEFAULT 0,
	`category_id` tinyint(4) NOT NULL,
	`amlccode` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`printorafterissuance` tinyint(4) NOT NULL,
	`branch_tin` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_checkcoordinate` (
	`checkid` int(11) AUTO_INCREMENT PRIMARY KEY,
	`employeeid` mediumint(9) NOT NULL,
	`printer` char(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`bank` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `general_clientchange` (
	...
	`birthdate` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`spouse` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cpnumber1` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cpnumber2` char(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`makerid` mediumint(9) NOT NULL,
	`approverid` mediumint(9) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_clientchangetemp` (
	`clientid` bigint(20) PRIMARY KEY,
	`branchid` smallint(6) NOT NULL,
	`branch` mediumint(9) NOT NULL,
	`firstname` char(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`middlename` char(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`lastname` char(55) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`birthdate` date NOT NULL,
	`spouseid` bigint(20) NOT NULL,
	`cpnumber1` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cpnumber2` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`onUpdateKYCLevelTo4` tinyint(4) NOT NULL,
	`makerid` mediumint(9) NOT NULL
);
--> statement-breakpoint
CREATE TABLE `general_clients` (
	`clientid` bigint(20) AUTO_INCREMENT PRIMARY KEY,
	`clientid_previous_cbs` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`clienttype` tinyint(4) NOT NULL,
	`orgtype` tinyint(4) NOT NULL,
	`firstname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`middlename` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`lastname` char(125) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`suffixname` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`gender` tinyint(4) NOT NULL,
	`birthdate` date NOT NULL,
	`birthplace` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	...
	`cpnumber1` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`cpnumber2` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`homenumber` varchar(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`businessnumber` varchar(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`tin` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`pagibig` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`philhealth` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`sss` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`gsis` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`id1type` tinyint(4) NOT NULL,
	`id1number` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`id1dateissued` date DEFAULT 'NULL',
	`id1placeissued` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`id2type` tinyint(4) NOT NULL,
	`id2number` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`id2dateissued` date DEFAULT 'NULL',
	`id2placeissued` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'NULL',
	`id2expiration` date NOT NULL,
	`addressdetails` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`barangayid` mediumint(9) NOT NULL,
	`addressdetails2` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`barangayid2` mediumint(9) NOT NULL,
	`emailaddress` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`facebookacct` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`contactperson` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`contactnumber` char(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`website` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`rep1_clientid` bigint(20) NOT NULL,
	`rep2_clientid` bigint(20) NOT NULL,
	`fundsource` tinyint(4) NOT NULL,
	`fundoccupation` tinyint(4) NOT NULL,
	`fundname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fundaddressdetails` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fundbarangayid` mediumint(9) NOT NULL,
	`fundposition` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fundcontact` char(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fundyearstart` char(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`fundgrossincome` int(11) NOT NULL,
	`spouseid` int(11) NOT NULL,
	`mmlastname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`mmfirstname` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`mmmiddlename` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`assetsizeid` mediumint(9) NOT NULL,
	`centerid` int(11) NOT NULL,
	`officeid` int(11) NOT NULL,
	`branch` smallint(6) NOT NULL,
	`datecreated` date NOT NULL DEFAULT '0000-00-00',
	`dateedited` date NOT NULL,
	`dateidissued` date NOT NULL,
	`riskprofile` tinyint(4) NOT NULL,
	`viptag` tinyint(4) NOT NULL,
	`dosri` tinyint(4) NOT NULL,
	`rpt` tinyint(1) unsigned NOT NULL,
	`pep` tinyint(1) unsigned NOT NULL,
	`smsEnrolled` tinyint(1) unsigned NOT NULL,
	`savingsid` bigint(10) unsigned NOT NULL,
	`client_uuid` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'uuid()',
	`fileCountSelfie` tinyint(1) NOT NULL DEFAULT false,
	`fileCountId` tinyint(1) NOT NULL DEFAULT false,
	`fileCountSignature` tinyint(1) NOT NULL DEFAULT false,
	`fileCountAttachment` tinyint(1) NOT NULL DEFAULT false,
	`fileCountRiskProfiling` tinyint(1) NOT NULL DEFAULT false
);
--> statement-breakpoint
...
CREATE INDEX `fk_savings_memoglcodes_glcode` ON `savings_memoglcodes` (`glcode`);--> statement-breakpoint
...
CREATE INDEX `orid` ON `lending_payment_tempdetails` (`orid`);--> statement-breakpoint
...
CREATE INDEX `journalid` ON `acctng_journaldetails` (`journalid`);--> statement-breakpoint
...
CREATE INDEX `general_systemdate_temp_ibfk_1` ON `general_systemdate_temp` (`branchid`);--> statement-breakpoint
...
CREATE INDEX `ib_journal_details_id` ON `acctng_journal_ibtracker` (`ib_journal_details_id`);--> statement-breakpoint
...
CREATE OR REPLACE ALGORITHM = undefined SQL SECURITY definer VIEW `vw_mobile_security_questions` AS (select 1 AS `questionid`,1 AS `question`);--> statement-breakpoint
CREATE OR REPLACE ALGORITHM = undefined SQL SECURITY definer VIEW `vw_mobile_security_question_answer` AS (select 1 AS `cpnumber`,1 AS `questionid`,1 AS `answer`);--> statement-breakpoint
CREATE OR REPLACE ALGORITHM = undefined SQL SECURITY definer VIEW `vw_savings_balance` AS (select 1 AS `accountname`,1 AS `savingsid`,1 AS `categoryname`,1 AS `savingsAccountType`,1 AS `corpclientid`,1 AS `client1id`,1 AS `client2id`,1 AS `client3id`,1 AS `client4id`,1 AS `currentbalance1`,1 AS `currentbalance2`,1 AS `holdoutamount`,1 AS `minimumbalance`);--> statement-breakpoint
CREATE OR REPLACE ALGORITHM = undefined SQL SECURITY definer VIEW `vw_savings_transactions` AS (select 1 AS `savingstransactionid`,1 AS `branchid`,1 AS `savingsid`,1 AS `transactiondate`,1 AS `reference`,1 AS `transactionname`,1 AS `postingtime`,1 AS `transactiontype`,1 AS `amount`,1 AS `currentbalance1`,1 AS `currentbalance2`);--> statement-breakpoint
CREATE OR REPLACE ALGORITHM = undefined SQL SECURITY definer VIEW `vw_transfer_details` AS (select 1 AS `sender_clientid`,1 AS `cpnumber`,1 AS `accountname`,1 AS `receiver_nickname`,1 AS `address`,1 AS `receiver_accountnumber`,1 AS `bicfi`,1 AS `bank_name`,1 AS `bank_code`,1 AS `head_office_brstn`);
*/