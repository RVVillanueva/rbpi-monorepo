...
export const costCentersView = mysqlView('cost_centers_view')
  .as(
    qb => qb
      .select({
        id: acctngCostCenter.id.as('id'),
        name: acctngCostCenter.name.as('name'),
        level: acctngCostCenter.level.as('level'),
        parent: acctngCostCenter.parent.as('parent'),
        childCount: acctngCostCenter.childcount.as('child_count'),
        categoryId: acctngCostCenter.categoryId.as('category_id'),
      })
  ...
  .as(
    qb => qb
      .select({
        ...
        subsidiary: acctngJournaldetails.subsidiary.as('subsidiary'),
